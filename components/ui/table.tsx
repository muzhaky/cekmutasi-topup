...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/50 transition-colors hover:bg-secondary/40 data-[state=selected]:bg-secondary/80",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle text-[0.7rem] font-semibold uppercase tracking-wide text-muted-foreground",
      className
    )}
    {...props}
  />
